...
{   
    ...
    gchar *output_entry_name[11]={"Мощность,кВт", "Число фаз", "Диапазон регулирования напряжения,В", 
    "Дискретность регулирования напряжения,В", "Диапазон регулирования частоты,Гц",
    "Дискретность регулирования частоты,Гц", "Диапазон регулирования скорости в разомкнутой системе",
    "Диапазон регулирования скорости в замкнутой системе",
    "Принцип управления", "Способ модуляции", "Тактовая частота ШИМ,кГц"};
